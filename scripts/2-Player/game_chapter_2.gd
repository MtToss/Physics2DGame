...
@onready var door1_label = $door1/Label1

@onready var door2 = $door2
@onready var door2_label = $door2/Label1

@onready var door3 = $door3
@onready var door3_label = $door3/Label1
...
func _input(event):
	...
	elif door1_label.visible and event.is_action_pressed("interact"):
		enuman.global_position = door2.global_position + Vector2(0, -10)
		dog.global_position = door2.global_position
		
	elif door2_label.visible and event.is_action_pressed("interact"):
		enuman.global_position = door1.global_position + Vector2(0, -10)
		dog.global_position = door1.global_position		
	elif door3_label.visible and event.is_action_pressed("interact"):
		enuman.global_position = door4.global_position + Vector2(0, -10)
		dog.global_position = door4.global_position
	
	elif door4_label.visible and event.is_action_pressed("interact"):
		enuman.global_position = door3.global_position + Vector2(0, -10)
		dog.global_position = door3.global_position
